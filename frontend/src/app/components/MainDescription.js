...
export default function MainDescription({className}){
    return (
        <div id="mainDescription" className={`w-[200px] md:w-[600px] lg:w-[705px] h-[300px] p-[20px]  flex flex-col justify-between mr-6 ${className}`}>
            <h1 className="font-bold text-xl md: text-4xl lg:text-6xl">Diversify your content</h1>
            <p className=" text-sm md:text-xl lg:text-2xl">Dubtok empowers creators to reach a global audience by allowing their videos to be viewed in different languages</p>
